        ...
        <div class="widget-list">
            <article class="card mb-4">
                <div class="card-image">
                    ...
                    <img loading="lazy" decoding="async" src="/assets/images/post/post-9.jpg" alt="Post Thumbnail"
                        class="w-100">
                </div>
            ...
            <a class="media align-items-center" href="/blogs/{{ $blog->slug }}">
                <img loading="lazy" decoding="async" src="/assets/images/post/post-2.jpg" alt="Post Thumbnail" class="w-100">
